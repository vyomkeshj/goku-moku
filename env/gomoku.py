...
if __name__ == '__main__':
    ...
    game.make_move([7, 7], PLAYER1)
    game.make_move([1, 8], PLAYER2)
    game.make_move([7, 8], PLAYER1)
    game.make_move([1, 9], PLAYER2)
    print(f"winner = {game.get_winner()}")

    game.make_move([7, 9], PLAYER1)
    game.make_move([2, 8], PLAYER2)
    game.make_move([7, 10], PLAYER1)
    game.make_move([2, 9], PLAYER2)
    game.make_move([7, 11], PLAYER1)
    print(f"winner = {game.get_winner()}")
